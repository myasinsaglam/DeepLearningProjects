...
###################################
size_image = 64
files_path = '/Users/Macbook/Desktop/image_retrieval_son_deneme'
...
model = tflearn.DNN(network, checkpoint_path='model_cbir_18.tflearn', max_checkpoints=3,
                    tensorboard_verbose=3, tensorboard_dir='/Users/Macbook/Desktop/image_retrieval_son_deneme/log8/')
###################################
# Train model for 200 epochs
###################################
model.load('model_cbir_18.tflearn-17592')
model.fit(X, Y, batch_size=32,
          n_epoch=70, run_id='model_cbir_18', show_metric=True)

model.save('model_cbir_18_final.tflearn')
